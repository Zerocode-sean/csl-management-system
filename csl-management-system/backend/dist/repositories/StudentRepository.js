...
class StudentRepository {
    ...
    `;
        ...
        try {
            ...
            logger_1.logger.info('Student created', { student_id: data.student_id });
            return result.rows[0];
        }
        catch (error) {
            logger_1.logger.error('Failed to create student', { data, error });
            throw error;
        }
    }
    /**
    ...
    async findById(id) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to find student by ID', { id, error });
            throw error;
        }
    }
    /**
    ...
    async findByStudentId(studentId) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to find student by student ID', { studentId, error });
            throw error;
        }
    }
    /**
    ...
    `;
        try {
            ...
            logger_1.logger.info('Student updated', { id });
            return result.rows[0];
        }
        catch (error) {
            logger_1.logger.error('Failed to update student', { id, data, error });
            throw error;
        }
    }
    /**
    ...
    `;
        try {
            const result = await (0, connection_1.query)(sql, [models_1.StudentStatus.WITHDRAWN, new Date(), id]);
            if (result.rowCount === 0) {
                throw new Error('Student not found');
            }
            logger_1.logger.info('Student deleted (soft)', { id });
        }
        catch (error) {
            logger_1.logger.error('Failed to delete student', { id, error });
            throw error;
        }
    }
    /**
    ...
    `;
        ...
        try {
            ...
            logger_1.logger.error('Failed to search students', { filters, pagination, error });
            throw error;
        }
    }
    /**
    ...
    `;
        try {
            ...
            logger_1.logger.error('Failed to find students by course', { courseId, error });
            throw error;
        }
    }
    /**
     ...
     */
    async existsByStudentId(studentId, excludeId) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to check student ID existence', { studentId, error });
            throw error;
        }
    }
    /**
    ...
    async existsByEmail(email, excludeId) {
        ...
        try {
            ...
            logger_1.logger.error('Failed to check email existence', { email, error });
            throw error;
        }
    }
}
