...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  useEffect(() => {
    const fetchCounts = async () => {
      try {
        ...
        setStudentCount(response.data.overview.active_students)
        setCertificateCount(response.data.overview.active_certificates)
      } catch (error) {
  ...
  const navigation: NavigationItem[] = [
    ...
    { name: 'Students', path: '/students', icon: Users, badge: studentCount },
    { name: 'Courses', path: '/courses', icon: BookOpen },
    { name: 'Certificates', path: '/certificates', icon: Award, badge: certificateCount },
